...
function Navigation() {
  ...
  return (
    <>
      <aside
        ref={sidebarRef}
        className={`group/sidebar relative z-[99999] flex h-full w-60 flex-col overflow-y-auto ${isResetting && 'transition-all duration-300 ease-in-out'} ${isMobile && 'w-0'}`}
      >
        <div
          onClick={collapse}
          role="button"
        ...
        <div className="flex items-center space-x-2 p-2">
          <img src="/Face.svg" height={24} width={24} alt="Face Logo" />
